...
class TestDouble(unittest.TestCase): 
    def test1(self): 
        self.assertEqual(add(2,4), 6) #When 2 and 4 are given as input the output must be 4.
        ...
        self.assertNotEqual(add(-2,-2), 0)# When -2 and -2 are given as input the output must not be 0. (Hint : Use assertNotEqual)
